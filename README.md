# Distilabel Chatbot using Anthropic Claude 3.5 Sonnet

This project is an AI chatbot built using a Distilabel pipeline integrated with the Anthropic Claude 3.5 Sonnet model. It generates responses dynamically based on user instructions and supports both predefined dataset inputs and real-time user queries.

##  Features

* Pipeline-based text generation using Distilabel
* Integrated with Anthropic Claude 3.5 Sonnet model
...
3. Integrated Claude 3.5 Sonnet model for response generation
